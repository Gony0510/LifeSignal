...
from ForMov.train_cnn import train_cnn  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="영상용 V-PR100 수면/대피/쓰러짐/무신호 1D CNN 학습"
    )
    parser.add_argument("--data", nargs="+", default=[str(VPR100_DEFAULT_DATA_PATH)])
    parser.add_argument("--output", default=str(VPR100_DEFAULT_CNN_PATH))
...
def main() -> None:
    ...
    try:
        ...
        raise SystemExit(f"영상용 V-PR100 1D CNN 학습 실패: {exc}") from exc
